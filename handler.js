            ...
            if (chat.welcome) {
              ...
              for (let user of participants) {
                ...
                try {
                  ...
                  console.error(`Error retrieving profile picture: ${error}`);
                  pp = 'https://i.ibb.co/72QpVJW/file-5990.jpg'; // Assign default image URL
                  ppgp = 'https://i.ibb.co/72QpVJW/file-5990.jpg'; // Assign default image URL
                } finally {
